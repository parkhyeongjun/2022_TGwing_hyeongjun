...
def short():
    ...
    print(lylic[8:13])# your code
    return

# 문제 7번
def myReverse(string):
    print(string[::-1])# your code
    return
...
def letMeIntroduceMyself():
    ...
    print("제 이름은 " + name +"입니다. 제 취미는 " + hobby + "이구요. 저는 " + university + "를 다니고 있습니다. 제 생일은 " + birth_month + birth_date + "입니다.")
    # your code
    return 
